...
**v0.1.13 已更新支持国服简中版本。** 启动时可以选择 `自动`、`简体`、`繁体`，不确定就选 `自动`。
...
1. 下载并运行 `CZNAutoSetup-0.1.13.exe`。
2. 安装时建议保留桌面快捷方式。
...
dist\installer\CZNAutoSetup-0.1.13.exe
```
