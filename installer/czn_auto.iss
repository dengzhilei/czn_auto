...
Source: "..\run_gui_exe.bat"; DestDir: "{app}"; DestName: "run_gui.bat"; Flags: ignoreversion
...
[Icons]
Name: "{group}\CZN Auto"; Filename: "{app}\run_gui.bat"; WorkingDir: "{app}"
Name: "{group}\CZN Auto Console Loop"; Filename: "{app}\run_min_loop.bat"; WorkingDir: "{app}"
...
Name: "{autodesktop}\CZN Auto"; Filename: "{app}\run_gui.bat"; WorkingDir: "{app}"; Tasks: desktopicon
